...
namespace Projet2Groupe1.Models
{
    public class Dal : IDal
    {
        ...
        public void InitializeDb()
        {
            ...
            _userService.CreateUser("Manel","Merini",0661218022,"MM@gmail.com","1234",UserRole.MEMBER);
            _userService.CreateUser("David", "Bisounours", 0781345676, "DB@gmail.com", "12345", UserRole.PREMIUM);
            _userService.CreateUser("Anthony", "Statek", 0328765439, "AS@gmail.com", "123", UserRole.ORGANIZER);
            _userService.CreateUser("Coleen", "Miclo", 0665432876, "CM@gmail.com", "12345", UserRole.PROVIDER);
